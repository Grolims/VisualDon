...
(function () {
  ...
  ***************************************************************************** */
  ...
  var color = {
      ...
      generateColor: function () {
          ...
          var pattern = notEmpty(config.color_pattern) ? config.color_pattern :
              ordinal($$.getColorFromCss() || schemeCategory10).range();
  ...
  var data = [
  	...
  	{
  		nom: "Street Fighter V: Arcade Edition",
  		totGain: 2017135.95
  	},
  	{
  		nom: "Brawlhalla",
  	...
  	{
  		nom: "Super Smash Bros. for Wii U",
  		totGain: 1511976.47
  	},
  	{
  	...
  	{
  		nom: "Super Street Fighter IV Arcade Edition",
  		totGain: 343878.08
  	},
  	{
  		nom: "Dragon Ball FighterZ",
  		totGain: 337985.4
  	},
  	{
  		nom: "Super Smash Bros. Brawl",
  		totGain: 246715.83
  	},
  	{
  		nom: "Killer Instinct (2013)",
  		totGain: 224466.96
  	},
  	{
  		nom: "Project M",
  	...
  	{
  		nom: "Guilty Gear Xrd REV 2",
  		totGain: 116749.7
  	},
  	{
  		nom: "Ultimate Marvel vs. Capcom 3",
  		totGain: 116733.16
  	},
  	{
  		nom: "Soul Calibur VI",
